...
const dockVariants = cva(
    "mx-auto w-auto min-w-max h-[58px] p-2 flex items-center justify-center gap-2 rounded-2xl border fixed bottom-3 left-1/2 transform -translate-x-1/2 px-1.5 bg-background",
);
...
function Page({ params }: { params: { slug: string } }) {
    ...
    const submitProject = async () => {
        ...
        const Create = await addDoc(collection(db, "submissions"), {
            ...
            time: date.format(new Date(), 'YYYY/MM/DD HH:mm:ss', true),
        })
    ...
    return (
        <>
            ...
            <Link href="/dashboard" className="flex-center fixed top-0 left-0 w-[201px] h-[28.25px] z-50 bg-background border">
