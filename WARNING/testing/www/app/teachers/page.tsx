...
const Teachers = () => {
  ...
  const [inputedMainTeachers, setInputedMainTeachers] = React.useState("")
  ...
  const handleMainTeachers = (event: any) => {
    setInputedMainTeachers(event.target.value);
  }
  ...
  useEffect(() => {
    const fetchDocs = async () => {
      ...
      docs.map((item: any) => {
        setInputedMainTeachers(item.mainTeachers);
  ...
  if (loading) {
    return <main className="w-full py-5 px-[5%] h-auto">
      <div className="flex items-center justify-between mb-6">
        <span className="text-center font-display text-lg font-bold tracking-[-0.02em] drop-shadow-sm md:text-3xl md:leading-[5rem]">Teachers</span>
      </div>
  ...
  return (
    ...
    <div>
      <main className="w-full py-5 px-[5%] h-auto pb-7 min-h-[90vh]">
        <div className="flex items-center justify-between mb-6">
          <span className="text-center font-display text-lg font-bold tracking-[-0.02em] drop-shadow-sm md:text-3xl md:leading-[5rem]">Teachers</span>
          <Link href="/create-Teachers">
            <Button size="sm">Add New Teachers</Button>
          </Link>
        </div>
          ...
          {docs.map((items) => (
            <div key={items.id}>
              ...
              <Card className="hover-glow-border w-full relative bg-primary-foreground">
                <CardHeader>
                  <CardTitle>{items.surname}</CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="w-full flex flex-col gap-2 border rounded-lg p-3 text-sm overflow-hidden">
                          <div className="flex gap-2 p-3">
                            <p>Username: </p>
                            <span className="font-semibold">{items.userName || "No Main Questing is Provided."}</span>
                          </div>
                          <Separator />
                          <div className="flex gap-2 p-3">
                            <p>Surname: </p>
                            <span className="font-semibold">{items.surname || "No Main Questing is Provided."}</span>
                          </div>
                          <Separator />
                          <div className="flex gap-2 p-3">
                            <p>Email: </p>
                            <span className="font-semibold">{items.email || "No Main Questing is Provided."}</span>
                          </div>
                        </div>
                </CardContent>
                  ...
                  <div className="flex gap-2 w-full justify-between mt-3">
                    <Dialog>
                      ...
                      <DialogContent className="w-[55%] min-w-[300px] max-w-[750px]">
                        <div className="w-full flex flex-col gap-2 border rounded-lg p-3 text-sm overflow-hidden">
                          ...
                          <div className="flex gap-2 p-3">
                            <p>Region: </p>
                            <span className="font-semibold">{items.region || "No Main Questing is Provided."}</span>
                          </div>
                          <Separator />
                          <div className="flex gap-2 p-3">
                            <p>Instagam: </p>
                            <span className="font-semibold">{items.instagam || "No Main Questing is Provided."}</span>
                          </div>
                          <Separator />
                          <div className="flex gap-2 p-3">
                            <p>Twitter: </p>
                            <span className="font-semibold">{items.twitter || "No Main Questing is Provided."}</span>
                          </div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <SheetContent side={"bottom"} className="h-[90vh] !max-w-[1600px] mx-auto rounded-xl">
                            ...
                            <div className="create-university min-h-[100vh] lg:flex lg:flex-col space-y-3 p-10 pt-3 !min-w-full lg:!min-w-[1500px]">
                              <div className="action w-full my-3 hidden lg:flex items-center justify-between ">
                                <div className="w-full h-full flex items-start justify-start space-x-3">
                                  <Link href="/teachers" className="z-50">
                                ...
                                <div className="w-full h-full flex items-end justify-end space-x-3">
                                  ...
                                  <Button
                                    ...
                                    onClick={async () => {
                                      ...
                                      const updateRef = doc(db, "users", items.id);
                                      const Update: any = await updateDoc(updateRef, {
                                        mainTeachers: inputedMainTeachers || items.mainTeachers,
                                      ...
                                      toast({
                                        ...
                                        description: (
                                          <div className="mt-2 w-[340px] rounded-md bg-primary-foreground p-4">
                                            <span>You Can now view and delete this Teachers!</span>
                              ...
                              {inputedValues && <div className="min-w-full w-max flex flex-col gap-2 border rounded-lg p-3 text-sm !mb-3">
                                <div className="flex gap-2 p-3">
                                  <p>MainQestion: </p>
                                  <span className="font-semibold">{inputedMainTeachers || "No MainQestion is Provided."}</span>
                                </div>
                                <Separator />
                                <div className="flex gap-2 p-3">
                            <p>Answers: </p>
                          ...
                          <div className="flex gap-2 p-3">
                            ...
                            <span className="font-semibold w-full overflow-y-hidden overflow-x-auto  truncate">
                              ...
                              <div className="hover-glow-border w-full h-auto border rounded-md flex flex-col space-y-3 items-center justify-center p-10">
                                <h1 className="text-4xl font-bold w-full text-left">MainTeachers</h1>
                                <Input onChange={handleMainTeachers} type="text" placeholder="Enter MainTeachers" />
                              </div>



                              <div className="action w-full my-3 flex flex-col lg:hidden items-start justify-start space-y-3 lg:space-y-0">
                                <Link href="/teachers" className="z-50 w-full">
                      ...
                      <Button onClick={async () => {
                        await deleteDoc(doc(db, "users", items.id));
                        const newDocs = docs.filter((item) => item.id !== items.id);
                        setDocs(newDocs);
