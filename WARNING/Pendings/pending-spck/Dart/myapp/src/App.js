...
import './App.css';
                const body = document.querySelector('body').childElementCount;
                console.log(body);
          ...
          <nav className="pro_navbar_main_container">
                ...
                <div className="pro_navbar_mb_sm pro_navbar_mb_lg pro_navbar_mb_lg">
                        ...
                        <div className="pro_navbar_mb_main-content">
                                ...
                                <input type="text/submit/hidden/button/image" name="" id="" value="" className="form-control" placeholder="Search for Joy" />
