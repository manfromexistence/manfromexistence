...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/dx/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/dx/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/dx/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/dx/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/dx/Projects/foobar/lib/utils")
})
