...
You can use any framework that supports React. [Next.js](https://ui.dx.com/docs/installation/next), [Astro](https://ui.dx.com/docs/installation/astro), [Remix](https://ui.dx.com/docs/installation/remix), [Gatsby](https://ui.dx.com/docs/installation/gatsby) etc.
