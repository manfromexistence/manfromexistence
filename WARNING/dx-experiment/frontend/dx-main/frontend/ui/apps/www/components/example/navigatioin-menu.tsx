...
export function NavigationMenuDropdown() {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="nav-toggles text-muted-foreground hover:text-primary">
            Products
          </NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid h-[500px] w-[400px] gap-3 overflow-x-hidden overflow-y-auto p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
        ...
        <NavigationMenuItem className="p-2 text-muted-foreground hover:text-primary">
