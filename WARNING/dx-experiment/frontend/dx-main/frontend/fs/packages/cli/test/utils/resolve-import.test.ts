...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/manofexistence/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/manofexistence/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/manofexistence/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/manofexistence/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/manofexistence/Projects/foobar/lib/utils")
})
