...
You can use any framework that supports React. [Next.js](https://ui.manofexistence.com/docs/installation/next), [Astro](https://ui.manofexistence.com/docs/installation/astro), [Remix](https://ui.manofexistence.com/docs/installation/remix), [Gatsby](https://ui.manofexistence.com/docs/installation/gatsby) etc.
