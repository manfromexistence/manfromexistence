...
```txt
Usage: manofexistence-ui init [options]
...
```bash
npx manofexistence-ui@latest add [component]
```
...
```txt
Usage: manofexistence-ui add [options] [components...]
...
```txt
Usage: manofexistence-ui diff [options] [component]
