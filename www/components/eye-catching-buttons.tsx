...
export const EyeCatchingButton_v1 = ({ ...props }: ButtonProps) => {
  return (
    <div className="relative overflow-hidden rounded-md bg-background group p-0.5">
      ...
      <Button
        {...props}
        className={cn(
          'h-10 px-4 w-full rounded-md font-semibold !text-primary backdrop-blur-xl !bg-transparent border',
          props.className
        )}
      />
    </div>
