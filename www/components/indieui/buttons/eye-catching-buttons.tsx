...
export const EyeCatchingButton_v1 = ({ ...props }: ButtonProps) => {
  return (
    <div className="relative overflow-hidden rounded-md dark:bg-zinc-900 bg-white shadow group p-0.5">
      ...
      <Button
        {...props}
        className={cn(
          'h-10 px-4 w-full rounded-md font-semibold !text-primary backdrop-blur-xl !bg-op border',
          props.className
        )}
      />
    </div>
