...
If you don't have [manfromexistence](https://ui.manfromexistence.com/docs/installation) installed in your project, you need to install the following packages:
...
If you have manfromexistence setup in your project, you can copy the code below and paste it in your project.
