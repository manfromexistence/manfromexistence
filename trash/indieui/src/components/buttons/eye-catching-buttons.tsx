...
export const EyeCatchingButton_v1 = ({ ...props }: ButtonProps) => {
  return (
    <div className="relative overflow-hidden dark:bg-red-900 bg-white shadow border dark:border-zinc-800 group border-zinc-400 p-0.5">
      ...
      <Button
        {...props}
        className={cn(
          'h-10 px-8 w-full font-semibold text-zinc-800 dark:text-zinc-200 backdrop-blur-xl bg-zinc-50 dark:bg-zinc-900',
          props.className
        )}
      />
    </div>
