...
export const EyeCatchingButton_v1 = ({ ...props }: ButtonProps) => {
  return (
    <div className="bg-background group relative overflow-hidden rounded-md p-0.5">
      ...
      <Button
        {...props}
        className={cn(
          '!text-primary !bg-op h-10 w-full rounded-md border px-4 font-semibold backdrop-blur-xl',
          props.className
        )}
      />
    </div>
