...
const dockVariants = cva(
    "bg-background mt-4 flex h-[58px] gap-2 rounded-2xl border p-2",
);
...
export default function IOSDOCk() {
    ...
    return (
        <div className="!pb-100 fixed bottom-4 left-1/2 z-50 flex w-full translate-x-[-50%] items-center justify-center">
            <Dock magnification={65} distance={113}>
                <DockIcon className="dark:bg-primary-foreground bg-secondary rounded-full p-1">
                ...
                <DockIcon className="dark:bg-primary-foreground bg-secondary rounded-full p-3">
                ...
                <DockIcon className="dark:bg-primary-foreground bg-secondary hidden rounded-full p-3 md:block">
                ...
                <DockIcon className="dark:bg-primary-foreground bg-secondary hidden rounded-full p-3 sm:block">
                ...
                <DockIcon className="dark:bg-primary-foreground bg-secondary hidden rounded-full p-3 lg:block">
                ...
                <DockIcon className="dark:bg-primary-foreground bg-secondary rounded-full p-3 lg:hidden">
                    <Drawer>
                        ...
                        <DrawerContent className="h-[80%]">
                            <div className="mt-4 flex w-full flex-col overflow-auto pl-4 pr-1">
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4 md:hidden" target="_blank" href="https://ai.manfromexistence.com">
                                    <h2>Ai</h2>
                                    <span className="text-muted-foreground">Copy & Past some ai related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4 sm:hidden" target="_blank" href="https://algorithm.manfromexistence.com">
                                    <h2>Algorithm</h2>
                                    <span className="text-muted-foreground">Copy & Past some algorithm related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4" target="_blank" href="https://auth.manfromexistence.com">
                                    <h2>Auth</h2>
                                    <span className="text-muted-foreground">Copy & Past some auth related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4 sm:hidden" target="_blank" href="https://backend.manfromexistence.com">
                                    <h2>Backend</h2>
                                    <span className="text-muted-foreground">Copy & Past some backend related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4 sm:hidden" target="_blank" href="https://blockchain.manfromexistence.com">
                                    <h2>Blockchain</h2>
                                    <span className="text-muted-foreground">Copy & Past some auth blockchain code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4" target="_blank" href="https://deployment.manfromexistence.com">
                                    <h2>Deployment</h2>
                                    <span className="text-muted-foreground">Copy & Past some backend deployment code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4 md:hidden" target="_blank" href="https://design-pattern.manfromexistence.com">
                                    <h2>Design Pattern</h2>
                                    <span className="text-muted-foreground">Copy & Past some design-pattern related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4" target="_blank" href="https://documentation.manfromexistence.com">
                                    <h2>Documentation</h2>
                                    <span className="text-muted-foreground">Copy & Past some documentation related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4 sm:hidden" target="_blank" href="https://frontend.manfromexistence.com">
                                    <h2>Frontend</h2>
                                    <span className="text-muted-foreground">Copy & Past some frontend related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4 sm:hidden" target="_blank" href="https://package.manfromexistence.com">
                                    <h2>Package</h2>
                                    <span className="text-muted-foreground">Copy & Past some package related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4" target="_blank" href="https://privacy.manfromexistence.com">
                                    <h2>Privacy</h2>
                                    <span className="text-muted-foreground">Copy & Past some privacy related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4 sm:hidden" target="_blank" href="https://test.manfromexistence.com">
                                    <h2>Test</h2>
                                    <span className="text-muted-foreground">Copy & Past some test related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4" target="_blank" href="https://theory.manfromexistence.com">
                                    <h2>Theory</h2>
                                    <span className="text-muted-foreground">Copy & Past some backend theory code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4" target="_blank" href="https://workspace.manfromexistence.com">
                                    <h2>Workspace</h2>
                                    <span className="text-muted-foreground">Copy & Past some workspace related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4" target="_blank" href="https://tool.manfromexistence.com">
                                    <h2>Tool</h2>
                                    <span className="text-muted-foreground">Copy & Past some tool related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4" target="_blank" href="https://benchmark.manfromexistence.com">
                                    <h2>Benchmark</h2>
                                    <span className="text-muted-foreground">Copy & Past some benchmark related code</span>
                                </Link>
                                <Link className="bg-primary-foreground mb-2 flex flex-col space-y-1 rounded-md p-4" target="_blank" href="https://observeability.manfromexistence.com">
