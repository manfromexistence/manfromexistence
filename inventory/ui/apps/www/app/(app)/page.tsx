  ...
  return (
    <div className="container flex max-w-screen-xl flex-col items-center space-y-8 pb-[75px]">
      ...
      <div className="mt-2 w-full space-y-8">
        ...
        <div className="text-muted-foreground flex w-full flex-col justify-between space-y-4 md:flex-row md:space-y-0">
          <div className="flex flex-col space-y-2 md:max-h-[200px] md:w-[60%]">
            ...
            <div className="flex h-full flex-col space-y-2 md:justify-end">
              <div className="flex flex-col">
                ...
                <div className="text-foreground flex items-center">
                  <CircleSlash2 className="mr-2 h-4 w-4" /> Jobless, Working on my own projects.
                </div>
              </div>
              <div className="flex flex-col">
                <span>Previously</span>
                <div className="text-foreground flex items-center">
                  <Briefcase className="mr-2 h-4 w-4" /> Freelancer at Fiverr & Upwork.
                </div>
              </div>
            </div>
          </div>
          <div className='w-full md:max-w-[400px]'>
            <div className="relative min-h-[200px] border border-dashed border-zinc-400 dark:border-zinc-700">
              ...
              <div className={cn('flex flex-col p-4')}>
                <div className='hover:bg-primary-foreground hover:text-primary flex w-full items-center justify-center space-x-4 rounded-md p-2 md:justify-evenly'>
                  ...
                  <div className='flex h-10 w-10 items-center justify-center rounded-full border p-1'>
                    ❤
                  </div>
                </div>
                <Separator className="my-4" />
                <div className='flex items-center justify-center space-x-2'>
                  <Link href={"https://www.youtube.com/@manfromexistence"} className='bg-primary-foreground text-primary flex h-12 w-12 items-center justify-center rounded-full'>
                    <YouTube />
                  </Link>
                  <Link href={"https://x.com/manfrexistence"} className='bg-primary-foreground text-primary flex h-12 w-12 items-center justify-center rounded-full'>
                    <XformerlyTwitter className="invert dark:invert-0" />
                  </Link>
                  <Link href={"https://github.com/manfromexistence"} className='bg-primary-foreground text-primary flex h-12 w-12 items-center justify-center rounded-full'>
                    <Github className="invert dark:invert-0" />
                  </Link>
                  <Link href={"https://www.linkedin.com/in/man-from-existence-a50180314/"} className='bg-primary-foreground text-primary flex h-12 w-12 items-center justify-center rounded-full'>
                    <LinkedIn />
                  </Link>
                  <Link href={"https://www.threads.net/@manfromexistence?xmt=AQGzX0O_Vpo7BfxG054NKG79SDenEBx2ZFmcE11qaGLN5uw"} className='bg-primary-foreground text-primary flex h-12 w-12 items-center justify-center rounded-full'>
                    <Threads className="invert dark:invert-0" />
                  </Link>
                  <Link target="_blank" href={"mailto:ajju40959@gmail.com"} className='bg-primary-foreground text-primary flex h-12 w-12 items-center justify-center rounded-full'>
                    <Gmail />
                  </Link>
                </div>
              </div>
        ...
        <div className='flex w-full flex-col gap-8 md:flex-row md:gap-4'>
          <div className='w-full lg:w-[30%]'>
            <div className="relative flex min-h-full items-center justify-center border border-dashed border-zinc-400 dark:border-zinc-700">
              <Icon className="-left-3 -top-3" />
              <Icon className="-right-3 -top-3" />
              <Icon className="-bottom-3 -left-3" />
              <Icon className="-bottom-3 -right-3" />
          ...
          <div className='w-full lg:w-[70%]'>
            <div className="relative min-h-full border border-dashed border-zinc-400 dark:border-zinc-700">
              <Icon className="-left-3 -top-3" />
              <Icon className="-right-3 -top-3" />
              <Icon className="-bottom-3 -left-3" />
              <Icon className="-bottom-3 -right-3" />
              <div className={cn('xs:grid-cols-1 grid min-h-full md:grid-cols-3')}>
                <div className='hover:bg-primary-foreground hover:text-primary relative flex w-full flex-col items-center justify-center border border-l-0 border-t-0 border-dashed p-8'>
                  <Icon className="-bottom-3 -right-3" />
                ...
                <div className='hover:bg-primary-foreground hover:text-primary relative flex w-full flex-col items-center justify-center border border-x-0 border-t-0 border-dashed p-8'>
                  <span className='text-7xl'>1+</span>
                  <span className='text-muted-foreground'>Facilitator</span>
                </div>
                <div className='hover:bg-primary-foreground hover:text-primary relative flex w-full flex-col items-center justify-center border border-l-0 border-t-0 border-dashed p-8 md:border-b-0'>
                  <span className='text-7xl'>1+</span>
                ...
                <div className='hover:bg-primary-foreground hover:text-primary relative flex w-full flex-col items-center justify-center border border-y-0 border-l-0 border-dashed p-8'>
